...
TEST(Cheby1Test, Cheby1BPFQ31Coeffs) {
    ...
    test_coeffs(cheby1_bpf, GAIN_EXPECTED, expected_coeffs, TOL_Q31_GRADE2);
}
...
TEST(Cheby1Test, Cheby1BPFQ31ImpulseResponse) {
    ...
    test_impulse_response(cheby1_bpf, expected, TOL_Q31_GRADE2);
}
...
TEST(Cheby1Test, Cheby1BSFQ31ImpulseResponse) {
    ...
    test_impulse_response(cheby1_bsf, expected, TOL_Q31_GRADE2);
}

TEST(Cheby1Test, Cheby1LPFQ15Coeffs) {
    IIRCheby1<1, q15_t> cheby1_lpf_q15(0.75, 0.1);
    ...
    test_coeffs(cheby1_lpf_q15, GAIN_EXPECTED, expected_coeffs, TOL_Q15);
}

TEST(Cheby1Test, Cheby1LPFQ15ImpulseResponse) {
    IIRCheby1<4, q15_t> cheby1_lpf(0.5, 0.3);
    ...
    test_impulse_response(cheby1_lpf, expected, TOL_Q15);
}
...
TEST(Cheby1Test, Cheby1BPFQ15Coeffs) {
    ...
    test_coeffs(cheby1_bpf, GAIN_EXPECTED, expected_coeffs, TOL_Q15);
}
...
TEST(Cheby1Test, Cheby1BSFQ15ImpulseResponse) {
    ...
    test_impulse_response(cheby1_bsf, expected, TOL_Q15);
}